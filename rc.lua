...
awful = require("awful")
conf_dir = awful.util.get_configuration_dir()
...
std = require("std")
nvlled = loadfile(conf_dir.."nvlled.lua")()

function startProgram(cmd) 
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ "Control",           }, ";", awful.tag.history.restore,
              {description = "go back", group = "tag"}),
    ...
    awful.key({ modkey, "Control" }, "b", 
                function() 
                    nvlled.spawn_on_current_tag(browser)
                end,
